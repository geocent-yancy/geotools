    ...
    public void paint(final Graphics2D graphics, final LiteShape2 shape, final GraphicLegend legend, final double scale, boolean isLabelObstacle) {
        ...
        while(symbolIter.hasNext()) {
            ...
            if (symbol instanceof Mark) {
                // No idea how to implement this. I was trying to follow the paint(...,Style2D,...) method,
                // but couldn't get close. This would need to be completed to fully implement the
                // SLD spec, but it isn't necessary for our current user story.
